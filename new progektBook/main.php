        ...
        <div class="col-6">
            <table class="table table-bordered border-primary tab text-break">
                ...
                foreach (loadMessages() as $row) {
                    echo "<tr><td class='tab-col'>" . dateFormat($row["date_time"]) . "</td><td>" .
                        smile($row["msg"]) . "</td><td>" . $row["name"] .
                        "</td></tr>";
                }
            ...
            <form action="add.php" method="post">
                <div class="form-floating">
                    <textarea name="msg" class="form-control" placeholder="Leave a comment here"
